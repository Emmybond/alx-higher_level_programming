 ...
 * @head: It reps pointer to pointer of first node of listint_t list
 * @n: It reps an integer to be included in new node
 ...
 * @head: It reps a pointer to list to be freed
 * Return: void
 */
